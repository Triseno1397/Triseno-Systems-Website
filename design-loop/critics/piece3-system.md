# System critic — piece 3: Web Design Division (`/web-design-division`)
Read `design-loop/design-system.md`, then judge every screenshot in `design-loop/shots/ours/p3/` against it. Do NOT open any source code. Do not judge taste — only adherence. Cite a filename for every finding.
