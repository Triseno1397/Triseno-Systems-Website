# System critic — piece 4: AI Infrastructure (`/ai-infrastructure`)
Read `design-loop/design-system.md`, then judge every screenshot in `design-loop/shots/ours/p4/` against it. Do NOT open any source code. Do not judge taste — only adherence. Cite a filename for every finding.
