    ...
    () => {
      ...
      mm.add("(prefers-reduced-motion: no-preference)", () => {
        const render = (p: number) => {
          ...
          if (spin.current) spin.current.style.transform = `rotate(${(-70 + eased * 70).toFixed(2)}deg) scale(${(1.18 - eased * 0.18).toFixed(3)})`;
        };
        render(0);
  ...
  return (
    ...
    >
      <div aria-hidden="true" className="sx-gate__scene">
        <span className="sx-glow sx-glow--gate" />
