...
function Operator({ state, onHue }: { state: OperatorState; onHue?: (hex: string) => void }) {
...
export default function RobotScene({
  ...
  return (
    ...
    >
      ...
      <directionalLight position={[-2, 1.5, -2]} intensity={3} color="#e8ecff" />
      <directionalLight position={[2, 0.5, -2]} intensity={2} color="#ffffff" />
      <Operator state={state} onHue={onHue} />
      <Floor />
    </Canvas>
  );
}
