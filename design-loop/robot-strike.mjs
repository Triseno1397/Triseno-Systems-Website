...
await p.addInitScript(() => { window.__progs = 0; for (const proto of [WebGL2RenderingContext.prototype, WebGLRenderingContext.prototype]) { const lp = proto.linkProgram; proto.linkProgram = function (x) { window.__progs++; return lp.call(this, x); }; } });
